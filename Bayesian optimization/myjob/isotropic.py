...
def load_data():
    A =  np.asarray( np.loadtxt('/home/xiao/combo/result_all.csv',skiprows=1,delimiter=',') )
...
class simulator:
	...
	with open('/home/xiao/combo/array.txt','a+') as file:   
	    #write_str = '%d'%(str(temp))  
    	    file.write(str(temp))  
        #os.system('/home/app/mpich-3.2/bin/mpirun -np 12 atkpython /home/xiao/folder/calculator.py >> model.log')
	os.system('mpirun -np 12 atkpython /home/xiao/combo/phonons.py >> model.log')
	...
	ff=open('/home/xiao/combo/dataout')
	reader = ff.readlines()
